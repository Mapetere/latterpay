...
class EnhancedWhatsApp:
    ...
    def send_cities_for_province(self, to: str, province: str) -> Dict:
        ...
        province_cities = {
            "province_harare": [
                {"id": "city_harare_central", "title": "Harare Central", "description": "Central Harare"},
                {"id": "city_harare_north", "title": "Harare North", "description": "Northern suburbs"},
                {"id": "city_harare_south", "title": "Harare South", "description": "Southern suburbs"},
                {"id": "city_chitungwiza", "title": "Chitungwiza", "description": "Chitungwiza town"},
                {"id": "city_epworth", "title": "Epworth", "description": "Epworth area"},
                {"id": "city_norton", "title": "Norton", "description": "Norton town"},
                {"id": "city_ruwa", "title": "Ruwa", "description": "Ruwa area"},
            ],
            "province_bulawayo": [
                {"id": "city_bulawayo_central", "title": "Bulawayo Central", "description": "Central Bulawayo"},
                {"id": "city_bulawayo_north", "title": "Bulawayo North", "description": "Northern suburbs"},
                {"id": "city_bulawayo_south", "title": "Bulawayo South", "description": "Southern suburbs"},
                {"id": "city_bulawayo_west", "title": "Bulawayo West", "description": "Western suburbs"},
            ],
            "province_mashonaland_east": [
                {"id": "city_marondera", "title": "Marondera", "description": "Provincial capital"},
                {"id": "city_ruwa", "title": "Ruwa", "description": "Ruwa area"},
                {"id": "city_mutoko", "title": "Mutoko", "description": "Mutoko town"},
                {"id": "city_mudzi", "title": "Mudzi", "description": "Mudzi district"},
                {"id": "city_uzumba", "title": "Uzumba", "description": "Uzumba area"},
            ],
            "province_mashonaland_west": [
                {"id": "city_chinhoyi", "title": "Chinhoyi", "description": "Provincial capital"},
                {"id": "city_kadoma", "title": "Kadoma", "description": "Mining town"},
                {"id": "city_chegutu", "title": "Chegutu", "description": "Chegutu town"},
                {"id": "city_karoi", "title": "Karoi", "description": "Karoi town"},
                {"id": "city_norton", "title": "Norton", "description": "Norton town"},
            ],
            "province_mashonaland_central": [
                {"id": "city_bindura", "title": "Bindura", "description": "Provincial capital"},
                {"id": "city_mt_darwin", "title": "Mt Darwin", "description": "Mt Darwin town"},
                {"id": "city_shamva", "title": "Shamva", "description": "Shamva town"},
                {"id": "city_mvurwi", "title": "Mvurwi", "description": "Mvurwi area"},
                {"id": "city_centenary", "title": "Centenary", "description": "Centenary town"},
            ],
            "province_midlands": [
                {"id": "city_gweru", "title": "Gweru", "description": "Provincial capital"},
                {"id": "city_kwekwe", "title": "Kwekwe", "description": "Industrial town"},
                {"id": "city_zvishavane", "title": "Zvishavane", "description": "Mining town"},
                {"id": "city_shurugwi", "title": "Shurugwi", "description": "Shurugwi town"},
                {"id": "city_gokwe", "title": "Gokwe", "description": "Gokwe town"},
                {"id": "city_redcliff", "title": "Redcliff", "description": "Redcliff town"},
            ],
            "province_masvingo": [
                {"id": "city_masvingo", "title": "Masvingo", "description": "Provincial capital"},
                {"id": "city_chiredzi", "title": "Chiredzi", "description": "Sugar estates"},
                {"id": "city_triangle", "title": "Triangle", "description": "Sugar town"},
                {"id": "city_gutu", "title": "Gutu", "description": "Gutu district"},
            ],
            "province_manicaland": [
                {"id": "city_mutare", "title": "Mutare", "description": "Provincial capital"},
                {"id": "city_chipinge", "title": "Chipinge", "description": "Border town"},
                {"id": "city_rusape", "title": "Rusape", "description": "Rusape town"},
                {"id": "city_nyanga", "title": "Nyanga", "description": "Mountain resort"},
                {"id": "city_chimanimani", "title": "Chimanimani", "description": "Mountain area"},
            ],
            "province_matebeleland_north": [
                {"id": "city_victoria_falls", "title": "Victoria Falls", "description": "Tourist town"},
                {"id": "city_hwange", "title": "Hwange", "description": "Mining town"},
                {"id": "city_lupane", "title": "Lupane", "description": "Provincial capital"},
                {"id": "city_binga", "title": "Binga", "description": "Lake Kariba area"},
            ],
            "province_matebeleland_south": [
                {"id": "city_gwanda", "title": "Gwanda", "description": "Provincial capital"},
                {"id": "city_beitbridge", "title": "Beitbridge", "description": "Border town"},
                {"id": "city_plumtree", "title": "Plumtree", "description": "Border town"},
                {"id": "city_filabusi", "title": "Filabusi", "description": "Mining area"},
            ],
        }
